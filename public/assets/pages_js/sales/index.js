    			...
    			$.ajax({
         			...
         			success: function(data){
	          			...
	          			if(response.confirmation == 'success'){
	            			...
	            			setTimeout(function(){ window.location.href = THEMEBASEURL+'sales'; }, 1800);
	          			} else{
  	...
  	swal({
    	...
    	preConfirm: function() {
	      	return new Promise(function(resolve) {
		       	$.ajax({
		        	url: THEMEBASEURL+'sales/salesdelete',
		        	type: 'POST',
		        	data: {
		          		'id'       : id,
		          		[CSRFNAME]    : CSRFHASH,
		       ...
		       .done(function(response){
		        	...
		        	setTimeout(function(){ window.location.href = THEMEBASEURL+'sales'; }, 2000);
		      	})
		       .fail(function(){
